...
export function LovableIcon({ className, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const PLATFORM_ICONS = {
    ...
    openai: { icon: OpenAIIcon, color: "text-[#10A37F]", bg: "bg-[#10A37F]/10", border: "border-[#10A37F]/20" },
    lovable: { icon: LovableIcon, color: "text-[#EC4899]", bg: "bg-[#EC4899]/10", border: "border-[#EC4899]/20" },
    bolt: { icon: BoltIcon, color: "text-[#FFB020]", bg: "bg-[#FFB020]/10", border: "border-[#FFB020]/20" },
} as const;