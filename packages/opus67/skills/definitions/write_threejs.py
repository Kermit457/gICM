#!/usr/bin/env python3
"""Write threejs-webgl.md skill definition."""

import os

SKILLS_DIR = os.path.dirname(os.path.abspath(__file__))

def write_threejs_webgl():
    content = r'''# Three.js & WebGL Expert
...
'''
    ...
    filepath = os.path.join(SKILLS_DIR, 'threejs-webgl.md')
    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)

    line_count = content.count('\n') + 1
    print(f"threejs-webgl.md: {line_count} lines")
    return line_count
