#!/usr/bin/env python3
"""Write chart-visualization-expert.md skill definition."""

import os

SKILLS_DIR = os.path.dirname(os.path.abspath(__file__))

def write_chart_visualization():
    content = r'''# Chart Visualization Expert
...
'''
    ...
    filepath = os.path.join(SKILLS_DIR, 'chart-visualization-expert.md')
    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)

    line_count = content.count('\n') + 1
    print(f"chart-visualization-expert.md: {line_count} lines")
    return line_count

if __name__ == "__main__":
    write_chart_visualization()
