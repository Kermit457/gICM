#!/usr/bin/env python3
"""
Generate comprehensive research and specialized skill definitions for OPUS 67
"""
...
def main():
    # Write deep-researcher.md
    with open(os.path.join(SKILLS_DIR, "deep-researcher.md"), "w", encoding="utf-8") as f:
        f.write(DEEP_RESEARCHER)

    print("✅ Generated deep-researcher.md")
