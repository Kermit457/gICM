 ...
 */
export async function workflowList(): Promise<{
  success: boolean;
...
export const workflowTools = {
  "dev.workflow_create": {
    description:
      "Create a new multi-agent workflow from a template or custom step definitions",
    parameters: {
      name: {
        type: "string",
      ...
      template: {
        type: "string",
        description:
          "Use a built-in template (audit-deploy, research-decide-trade, scan-all-chains)",
        optional: true,
      },
      description: {
        type: "string",
