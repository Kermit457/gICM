...
export const researchAndAnalyze: Pipeline = {
...
// ============================================================================
// Token Swap Templates
// ============================================================================

export const swapToken: Pipeline = {
  id: 'swap-token',
  name: 'Token Swap',
...
export const contentGeneration: Pipeline = {
...
export const securityAudit: Pipeline = {
  id: 'security-audit',
  name: 'Security Audit',
...
export const portfolioAnalysis: Pipeline = {
...
export function getTemplate(id: string): Pipeline | undefined {
  return PIPELINE_TEMPLATES[id];
}

export function listTemplates(): Pipeline[] {
  return Object.values(PIPELINE_TEMPLATES);
}

export function listTemplatesByCategory(category: string): Pipeline[] {
